...
public class TigerLvalueImpl extends ASTWrapperPsiElement implements TigerLvalue {

  public TigerLvalueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<TigerLvalueSuffix> getLvalueSuffixList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TigerLvalueSuffix.class);
  }
