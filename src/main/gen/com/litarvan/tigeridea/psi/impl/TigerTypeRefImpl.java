...
public class TigerTypeRefImpl extends ASTWrapperPsiElement implements TigerTypeRef {

  public TigerTypeRefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public TigerParameters getParameters() {
    return findChildByClass(TigerParameters.class);
  }
