...
public class TigerVariableDeclarationImpl extends ASTWrapperPsiElement implements TigerVariableDeclaration {

  public TigerVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public TigerExpression getExpression() {
    return findNotNullChildByClass(TigerExpression.class);
  }
