...
public class TigerLvalueSuffixImpl extends ASTWrapperPsiElement implements TigerLvalueSuffix {

  public TigerLvalueSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TigerVisitor visitor) {
    visitor.visitLvalueSuffix(this);
  }
